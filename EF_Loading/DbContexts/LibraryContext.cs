...
using EF_Loading.Models;
using Microsoft.EntityFrameworkCore;

namespace EF_Loading.DbContexts;
...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<GetBooksCategoryAuthor> GetBooksCategoryAuthors { get; set; }

    public virtual DbSet<GetBooksWithCategoryName> GetBooksWithCategoryNames { get; set; }

    public virtual DbSet<GetBooksWithFullDatum> GetBooksWithFullData { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) 
        => optionsBuilder.UseSqlServer("Data Source=STHQ012D-01;Initial Catalog=Library;User ID=admin;Password=admin;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True;")
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GetBooksCategoryAuthor>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetBooksCategoryAuthors");

            entity.Property(e => e.AuthorName).HasMaxLength(15);
            entity.Property(e => e.AuthorsSurname).HasMaxLength(25);
        ...
        modelBuilder.Entity<GetBooksWithCategoryName>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetBooksWithCategoryName");
        ...
        modelBuilder.Entity<GetBooksWithFullDatum>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetBooksWithFullData");

            entity.Property(e => e.AuthorsFullName).HasMaxLength(41);
            entity.Property(e => e.CategoryName)
                .HasMaxLength(30)
                .HasColumnName("categoryName");
            entity.Property(e => e.Name).HasMaxLength(100);
            entity.Property(e => e.PressName).HasMaxLength(30);
            entity.Property(e => e.ThemeName).HasMaxLength(30);
        });
